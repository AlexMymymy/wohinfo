<?php 
  ...
  //  $mysqli = new  mysqli("mysql1.000webhost.com", "a4962533_user", "psw123", 'a4962533_base');
    if($mysqli->connect_errno)
    {
      die("Could not connect mysqli: " . $mysqli->connect_error);
    }
  //}
  ...
  if($result->num_rows == 0)
  {
    ...
    INSERT INTO build_name (build_id, name, pict_offset) 
      VALUES (0,'Алтарь',0)
            ...
            ,(27,'Дом охотника', 0)
            ,(28,'Водозабор', 0)
            ,(29,'Центр управления полетами', 0)
            ,(32,'Мастерская', 0)
            ...
            ,(96,'Дом собирателя', 0)
            ,(97,'Оракул', 0)
            ,(98,'Орден тамплиеров', 0)
            ,(98,'Академия СунЦзы', 0)
            ,(100,'Мачу-Пикчу', 0)
